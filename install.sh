...
print_success() {
    ...
    echo ""
    echo "  4. Or with collection context:"
    echo -e "     ${BLUE}shad run \"Summarize my notes\" --collection ~/MyVault${NC}"
    echo ""
    echo "Commands:"
    ...
    echo "  If qmd is installed, register your collection for hybrid search:"
